...
SubgroupPlot$subgroup[SubgroupPlot$subgroup %in% "New"] <- "1.Without prior TB history"
SubgroupPlot$subgroup[SubgroupPlot$subgroup %in% "Old"] <- "2.With prior TB history"
SubgroupPlot$subgroup[SubgroupPlot$subgroup %in% "Young"] <- "3.Young [15,25)"
...
# SubgroupPlot$subgroup[SubgroupPlot$subgroup %in% ""] <-
# SubgroupPlot$subgroup[SubgroupPlot$subgroup %in% ""] <-
