...
# make it long
Adult_Valid$qXRv2_100 <- Adult_Valid$qXRv2*100

Adult_Valid_long <- gather(Adult_Valid, DeepLearningSystem, AbnormalityScore, CAD4TB6, qXRv2_100)


# p <- ggplot(Adult_Valid,aes(CAD4TB6))
# p <- ggplot(Adult_Valid,aes(qXRv2))
...
# library(moments)
# skewness(Adult_Valid[Adult_Valid$Xpert2Outcome_num ==1, 28]) #28 CAD4TB6, 29 qXRv2, 33 Lunit
# skewness(Adult_Valid[Adult_Valid$Xpert2Outcome_num ==1, 29]) #29 qXRv2, 33 Lunit
# skewness(Adult_Valid[Adult_Valid$Xpert2Outcome_num ==1, 33]) #33 Lunit
# 
# skewness(Adult_Valid[Adult_Valid$Xpert2Outcome_num ==0, 28]) #28 CAD4TB6, 29 qXRv2, 33 Lunit
# skewness(Adult_Valid[Adult_Valid$Xpert2Outcome_num ==0, 29]) #29 qXRv2, 33 Lunit
...
roc_qure <- ci.auc(Xpert2Outcome_num ~ qXRv2_100, Adult_Valid)
...
Adult_Valid_long$DeepLearningSystem[Adult_Valid_long$DeepLearningSystem %in% "qXRv2_100"] <- "qXR"
...
perc_above_CAR_Score<- sum(CountryX$qXRv2 >= car.cutoff)/length(CountryX$TID_OMRS)
