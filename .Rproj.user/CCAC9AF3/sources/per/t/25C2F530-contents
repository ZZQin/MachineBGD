...
Radiologist$Specificity <- paste(round(Radiologist$Spec, 3), "(", round(Radiologist$Spec_L, 3), "-", round(Radiologist$Spec_H,3), ")", sep = "")


###### Qure.AI Score by 0.01 #########
qure_ai_score <- seq(0,1, by = 0.01)
...
QureDF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
for (i in 1:101){
  ...
  accuracy <- myfunction(MDF, LunitVector[i])
  mylist[[i]] <- list(accuracy)

}

LunitDF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
# write.csv(LunitDF, "Lunit by 0.01.csv")
rm(LunitVector)



###### JF1 Score by 0.01 #########
JF1Vector <- seq(0,1, by = 0.01)
...
for (i in 1:101){
  ...
  accuracy <- myfunction(MDF, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
  
}

JF1DF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
# write.csv(JF1DF, "JF1 by 0.01.csv")
rm(JF1Vector)


###### JF2 Score by 0.01 #########
JF2Vector <- seq(0,1, by = 0.01)
...
for (i in 1:101){
  ...
  accuracy <- myfunction(MDF, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
  
}

JF2DF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
# write.csv(JF2DF, "JF2 by 0.01.csv")
rm(JF2Vector)



###### IF1 Score by 0.01 #########
IF1Vector <- seq(0,1, by = 0.01)
...
for (i in 1:101){
  ...
  accuracy <- myfunction(MDF, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
  
}

IF1DF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
# write.csv(IF1DF, "IF1 by 0.01.csv")
rm(IF1Vector)


###### IF2 Score by 0.01 #########
IF2Vector <- seq(0,1, by = 0.01)
...
for (i in 1:101){
  ...
  accuracy <- myfunction(MDF, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
  
}

IF2DF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
# write.csv(IF2DF, "IF2 by 0.01.csv")
rm(IF2Vector)

###### IF3 Score by 0.01 #########
IF3Vector <- seq(0,1, by = 0.01)
...
for (i in 1:101){
  ...
  accuracy <- myfunction(MDF, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
  
}

IF3DF <- data.frame(matrix(unlist(mylist), nrow=101, byrow=T))
...
CAD_Xpert_plot <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

write.csv(CAD_Xpert_plot, "Results/CAD_Xpert Cutoffs TABLE.csv")
View(CAD_Xpert_select[, c(2,3,7, 8, 12, 4,5)])
write.csv(CAD_Xpert_select, "Results/Supp Tab.csv", row.names = F)
