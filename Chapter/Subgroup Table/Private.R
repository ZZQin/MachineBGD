...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(Private, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Private, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_Private <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_Private$subgroup <- "Private"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_Private, "Results/CAD_Xpert Cutoffs TABLE_Private.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_Private.csv", row.names = F)
