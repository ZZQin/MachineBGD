...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(WalkIn, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(WalkIn, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_WalkIn <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_WalkIn$subgroup <- "WalkIn"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_WalkIn, "Results/CAD_Xpert Cutoffs TABLE_WalkIn.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_WalkIn.csv", row.names = F)
