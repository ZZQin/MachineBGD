...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(Referral, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Referral, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_Referral <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_Referral$subgroup <- "Referral"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_Referral, "Results/CAD_Xpert Cutoffs TABLE_Referral.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_Referral.csv", row.names = F)
