...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(Senior, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Senior, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_Senior <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_Senior$subgroup <- "Senior"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_Senior, "Results/CAD_Xpert Cutoffs TABLE_Senior.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_Senior.csv", row.names = F)
