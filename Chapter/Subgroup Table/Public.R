...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(Public, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Public, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_Public <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_Public$subgroup <- "Public"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_Public, "Results/CAD_Xpert Cutoffs TABLE_Public.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_Public.csv", row.names = F)
