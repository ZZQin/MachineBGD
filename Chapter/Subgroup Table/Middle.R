...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(Middle, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(Middle, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_Middle <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_Middle$subgroup <- "Middle"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_Middle, "Results/CAD_Xpert Cutoffs TABLE_Middle.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_Middle.csv", row.names = F)
