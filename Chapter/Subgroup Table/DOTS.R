...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, qure_ai_score[i])
...
for (i in 1:101){
  ...
  accuracy_both <- myfunction(DOTS, CAD6[i])
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, LunitVector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, JF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, JF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, IF1Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, IF2Vector[i])
  mylist[[i]] <- list(accuracy)
...
for (i in 1:10001){
  ...
  accuracy <- myfunction(DOTS, IF3Vector[i])
  mylist[[i]] <- list(accuracy)
...
CAD_Xpert_plot_DOTS <- CAD_Xpert[, c(16, 21, 14, 13, 15, 1:3, 4,7, 5,6,8:12, 23:27, 22)]

CAD_Xpert_plot_DOTS$subgroup <- "DOTS"

# CAD_Xpert_select <- CAD_Xpert_select[!CAD_Xpert_select$DeepLearningSystem %in% c("IF1", "JF2", "IF3"), ]

# write.csv(CAD_Xpert_plot_DOTS, "Results/CAD_Xpert Cutoffs TABLE_DOTS.csv")
# write.csv(CAD_Xpert_select, "Results/Supp Tab_DOTS.csv", row.names = F)
