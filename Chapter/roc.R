...
ggROC <- base + theme_minimal() + geom_abline(slope=1, intercept = 0, linetype = "dashed", alpha=0.7, color = "grey") + coord_equal()+ annotate("text", x = .75, y = .15, label = paste(" CAD4TB: ", round(roc_CAD6[2],2), " (95% CI:", round(roc_CAD6[1],2), "-", round(roc_CAD6[3],2), ")", "\n", "InferReadDR: ", round(roc_IF2[2],2), " (95% CI:", round(roc_IF2[1],2), "-", round(roc_IF2[3],2), ")", "\n",
                                                                                                                                                              # "IF3: ", round(roc_IF3[2],2), " (95% CI:", round(roc_IF3[1],2), "-", round(roc_IF3[3],2), ")", "\n",
                                                                                                                                                              ...
                                                                                                                                                              # "IF1: ", round(roc_IF1[2],2), " (95% CI:", round(roc_IF1[1],2), "-", round(roc_IF1[3],2), ")", "\n",
                                                                                                                                                                                                                                                                                                          "Lunit INSIGHT CXR: ", round(roc_Lunit[2],2), " (95% CI:", round(roc_Lunit[1],2), "-", round(roc_Lunit[3],2), ")", "\n",
...
tiff("ROC Zoomed-in", width = 8, height = 3.2, units = "in", res = 100)
ggROC1
dev.off()
