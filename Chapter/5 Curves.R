...
base <- ggplot(CAD_Xpert_plot, aes(Score, nnt)) + geom_path(aes(color = AI)) + scale_fill_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) +  scale_color_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) 
# + geom_ribbon(data = CAD_Xpert_plot %>% filter(Score <0.95), aes(x = Score, ymin = NNT_L, ymax = NNT_H, color = AI, fill = AI), alpha= 0.2) 
...
base <- ggplot(CAD_Xpert_plot, aes(Score, X.XpertSaved)) + geom_path(aes(color = AI))  + scale_fill_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) +  scale_color_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) 
...
base <- ggplot(CAD_Xpert_plot, aes(X.XpertSaved, Sens)) + geom_path(aes(color = AI, fill = AI))  + scale_fill_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) +  scale_color_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) + 
  geom_ribbon(aes(x = X.XpertSaved, ymin = Sens_L, ymax = Sens_H, color = AI, fill = AI), alpha= 0.2) 
...
base <- ggplot(CAD_Xpert_plot, aes(Score, Spec)) + geom_path(aes(color = AI))  + scale_fill_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) +  scale_color_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) + 
  geom_ribbon(data = CAD_Xpert_plot %>% filter(Score <0.95), aes(x = Score, ymin = Spec_L, ymax = Spec_H, color = AI, fill = AI), alpha= 0.2) 
...
base <- ggplot(CAD_Xpert_plot, aes(X, Sens)) + geom_path(aes(color = AI)) + geom_ribbon(aes(x = X, ymin = Sens_L, ymax = Sens_H, color = AI, fill = AI), alpha= 0.2) + scale_fill_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) +  scale_color_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) 
# + geom_ribbon(aes(y = Sens, xmin = X_L, xmax = X_H, color = AI, fill = AI), alpha= 0.2) 
...
### b. PRC ------
base <- ggplot(CAD_Xpert_plot, aes(Sens, ppv)) + geom_path(aes(color = AI, fill = AI)) + scale_fill_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) +  scale_color_manual(values=c("#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00")) + 
  geom_ribbon(data = CAD_Xpert_plot %>% filter(Sens >0.02), aes(x = Sens, ymin = PPV_L, ymax = PPV_H, color = AI, fill = AI), alpha= 0.2) 
...
tiff("09_Results/5 Curves.tif", width = 8, height = 12, units = "in", res = 100)
require(gridExtra)
